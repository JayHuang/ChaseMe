...
import org.chaseme.fragments.helpers.CameraGroundOverlays;
...
public class EditorMapFragment extends DroneMap implements
	...
	private void updateInfoWindow(GenericWaypoint waypoint, Marker marker) {
		...
		if(distanceFromPrevPathPoint != org.chaseme.drone.variables.mission.waypoints.GenericWaypoint.UNKNOWN_DISTANCE)
