...
import org.chaseme.file.DirectoryPath;
...
public class SettingsFragment extends PreferenceFragment implements
  ...
  //               sharedPref.getString("pref_vehicle_type", ""));
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
		...
		// 	findPreference(key)
		// 			.setSummary(sharedPreferences.getString(key, ""));
		// 	//((ChaseMeApp) getActivity().getApplication()).drone.notifyMapTypeChanged();
		// }
  //       if (key.equals("pref_vehicle_type")) {
		// 	findPreference(key)
		// 			.setSummary(sharedPreferences.getString(key, ""));
		// 	((ChaseMeApp) getActivity().getApplication()).drone.events.notifyDroneEvent(DroneEventsType.TYPE);
  //       }
