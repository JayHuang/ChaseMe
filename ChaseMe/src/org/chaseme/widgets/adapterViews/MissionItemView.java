package org.chaseme.widgets.adapterViews;
...
public class MissionItemView extends ArrayAdapter<org.chaseme.drone.variables.mission.MissionItem> {

	private Context context;
	private List<org.chaseme.drone.variables.mission.MissionItem> waypoints;
	...
	public MissionItemView(Context context, int resource, List<org.chaseme.drone.variables.mission.MissionItem> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		org.chaseme.drone.variables.mission.MissionItem waypoint = waypoints.get(position);
...
*/
	...
	private void setupViewsText(org.chaseme.drone.variables.mission.MissionItem item) {
